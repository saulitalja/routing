...
def bgp_simulation():
    ...
    tele2.routing_table = {'172.16.0.0/16': 8}  # Lisätään oma reitti Tele2:lle
    ...
    # Visualisoi verkko
    visualize_bgp([elisa, telia, dna, tele2])
